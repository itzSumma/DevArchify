...
function LoginForm() {
  ...
  const handleDemoLogin = async () => {
    ...
    console.log("DEMO_LOGIN_EMAIL:", JSON.stringify(DEMO_EMAIL));
    console.log(
      "DEMO_LOGIN_EMAIL_CHARS:",
      DEMO_EMAIL.split("").map((c) => c.charCodeAt(0)),
    );
  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-8">
      ...
      <button
        ...
        disabled={loading}
        className="flex w-full items-center justify-center pt-5 gap-3 rounded-2xl border border-slate-700 bg-slate-900 px-4 py-3.5 font-bold text-slate-300 transition hover:bg-slate-800 disabled:opacity-70">
